            ...
            <Switch>
              ...
              <Route exact path="/PS4-games">
                <Row
                  ...
                  fetchUrl={requests.fetchPS4Games}
                />
              </Route>
              ...
              <Route exact path="/Action-games">
                <Row
                  title="Action Games"
                  fetchUrl={requests.fetchActionGames}
                />
              </Route>
              <Route exact path="/Racing-games">
                <Row
                  title="Racing Games"
                  fetchUrl={requests.fetchRacingGames}
                />
              </Route>
              <Route exact path="/Adventure-games">
                <Row
                  title="Adventure Games"
                  fetchUrl={requests.fetchAdventureGames}
                />
              </Route>
              <Route exact path="/Shooter-games">
                <Row
                  title="Shooter Games"
                  fetchUrl={requests.fetchShooterGames}
                />
              </Route>
              <Route exact path="/Strategy-games">
                <Row
                  title="Strategy Games"
                  fetchUrl={requests.fetchStrategyGames}
                />
              </Route>
              <Route exact path="/Fighting-games">
                <Row
                  title="Fighting Games"
                  fetchUrl={requests.fetchFightingGames}
                />
              </Route>
            </Switch>
          </div>
