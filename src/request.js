...
const requests = {
    ...
    fetchPCGames:`https://api.rawg.io/api/games?key=${API_KEY}&platform=1&dates=2020-01-01,2021-09-21&page=2`,
    fetchPS4Games:`https://api.rawg.io/api/games?key=${API_KEY}&platform=2&dates=2020-01-01,2021-09-21`,
    fetchXboxGames:`https://api.rawg.io/api/games?key=${API_KEY}&platform=3&dates=2020-01-01,2021-09-21&page=3`,
}
